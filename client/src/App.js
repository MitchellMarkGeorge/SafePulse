      ...
      <AuthContext.Provider value={{ userData, setUserData }}>
        <Routes>
          ...
          <Route
            path={ROUTES.HOME}
            element={
              !isAuthenticated ? <Navigate to={ROUTES.LOGIN} /> : <Home />
            }
          />
          <Route
            path={ROUTES.SAFE_USE}
            element={
              !isAuthenticated ? <Navigate to={ROUTES.LOGIN} /> : <SafeUse />
            }
          />
          ...
          <Route
            path={ROUTES.LOGIN}
            element={
              isAuthenticated ? <Navigate to={ROUTES.HOME} /> : <Login />
            }
          />
          <Route
            path={ROUTES.SIGNUP}
            element={
              isAuthenticated ? <Navigate to={ROUTES.HOME} /> : <SignUp />
            }
          />
